...
// `upsertBootstrapBlock`도 같은 파일을 읽는다. label은 어느 루트 파일에 쓰는지만
// 고르고 본문은 고르지 않는다 — 루트 `AGENTS.md`와 `CLAUDE.md`가 같은 블록을 받아야
// host에 따라 로드되는 계약이 갈리지 않는다. 못 읽으면 던진다 — 조용히 건너뛰면
