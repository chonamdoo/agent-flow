---
name: agp-9-upgrade
description: Upgrades or migrates an Android project to Android Gradle Plugin 9, including built-in Kotlin, the new DSL, KSP or legacy-kapt, and BuildConfig changes. Use when an Android project is moving to AGP 9; do not use for Kotlin Multiplatform projects.
