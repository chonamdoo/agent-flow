...
- If project-local skills were checked, record `project-local-skills: checked` and `project-local-skills-used: <skill list>`. If no project-local skill applies, record `project-local-skills: n/a` and `project-local-skills-used: n/a`.
