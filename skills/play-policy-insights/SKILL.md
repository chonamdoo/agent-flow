...
description: Audits Android applications against Google Play policy domains by comparing static code signals with Play Store declarations and producing deterministic compliance reports. Use when checking permissions and API hygiene, account deletion or demo credentials, Data Safety disclosures, privacy risks, or pre-submission Play compliance.
