...
taskTerms: [viewmodel, uistate, uievent, uiaction, uimodel, stateflow, state holder, compose screen, 상태 홀더, 화면 상태, 프레젠테이션]
pathGlobs: ["**/*ViewModel.kt", "**/*UiState.kt", "**/*Screen.kt", "**/presentation/src/main/**/*.kt"]
required_markers:
