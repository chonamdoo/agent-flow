---
name: write-for-work
description: Draft, rewrite, restructure, or review Korean and English work writing for documentation, business and strategy reports, decision memos, project updates, and public or social thread posts. Use when writing must become clearer, more natural, less AI-generated, less dependent on imported workplace jargon, more decision-friendly, or better matched to a specific reader while preserving facts, evidence, numbers, terminology, links, and the author's intended voice. Also use for before-and-after comparisons, logic and evidence audits, executive summaries, plain-language conversion, and converting technical material for non-technical readers.
---
...
6. Format: document, report, memo, HTML, email, or public thread.
...
6. Compare every material claim, number, and name against the source.
